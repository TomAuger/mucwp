...
require_once( ZG_LIB . 'Webformz/Valz_Widgetform.php' );
...
class ZG_Widget extends WP_Widget {
	...
	/**
	 * @var Valz_Webform the admin options form object defined in {@link form()}
	 */
	protected $form;
	...
	*/
	...
	public function form($instance) {
		...
		$this->form = new Valz_WidgetForm($this, $instance);

		$this->form->addField(array('id'=>'hide_title', 'label'=>__('Hide Title'), 'type'=>'checkbox'));
		$this->form->addField(array('id'=>'title', 'label'=>__('Title'), 'class'=>'widefat'));

		$this->add_admin_form_content( $this->form, $instance );
